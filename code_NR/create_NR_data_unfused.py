...
def feature_extraction(node_signal_tensor, fs, AE, exp=0, cluster=0, is_target=False): #pro sample 4x feature extraction
    ...
    for n in range(num_nodes):
        ...
        lmbe_spectogram = utilities.lmbe(node_signal, sr=fs)
        AE.encode_only()
    ...
    print(f"    \033[0;31mmax: {output.max():.3f}\033[0m")
    return output
...
if data_for == 'id':
    savepath_prefix = '/home/student/Documents/WHK_Projekt_1/work_remastered/DATA/ID_data/ID_unfused_del/'
elif data_for == 'nr':
    savepath_prefix = '/home/student/Documents/WHK_Projekt_1/work_remastered/DATA/NR/NR_unfused4/'###############
else:
    exit(1)
